...
if (~exist('4DLF_MI_viola', 'dir'))
    mkdir('4DLF_MI_viola');
end
if (~exist('4DLF_PVS_viola', 'dir'))
    mkdir('4DLF_PVS_viola');
end
...
for i = 1:1
    ...
    LFUtilDecodeLytroFolder(strcat('./', listing(i).name), [], struct('OptionalTasks', 'ColourCorrect3')); 
end
...
for i = 1:1
   ...
   % lenslet_rgb_img = reconstruct_lenslet_img(LF);
    ...
    if use_10bpp == 1
        ...
        % RGB Actual writing
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_RGB444_10bpp.rgb'), 'w' );
        fwrite(fileID, permute(lenslet_rgb_img, [2 1 3]), 'uint16');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_R444_10bpp.rgb'), 'w' );
        fwrite(fileID, lenslet_rgb_img(:, :, 1)', 'uint16');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_G444_10bpp.rgb'), 'w' );
        fwrite(fileID, lenslet_rgb_img(:, :, 2)', 'uint16');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_B444_10bpp.rgb'), 'w' );
        fwrite(fileID, lenslet_rgb_img(:, :, 3)', 'uint16');
        fclose(fileID);
        % YUV Actual writing
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_YUV444_10bpp.yuv'), 'w' );
        fwrite(fileID, permute(lenslet_yuv_img, [2 1 3]), 'uint16');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_Y444_10bpp.yuv'), 'w' );
        fwrite(fileID, lenslet_yuv_img(:, :, 1)', 'uint16');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_U444_10bpp.yuv'), 'w' );
        fwrite(fileID, lenslet_yuv_img(:, :, 2)', 'uint16');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_V444_10bpp.yuv'), 'w' );
        fwrite(fileID, lenslet_yuv_img(:, :, 3)', 'uint16');
        fclose(fileID);
        % YUV Actual writing
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_YUV420_10bpp.yuv'), 'w' );
        ...
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_Y420_10bpp.yuv'), 'w' );
        fwrite(fileID, lenslet_yuv420_img{1}', 'uint16');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_U420_10bpp.yuv'), 'w' );
        fwrite(fileID, lenslet_yuv420_img{2}', 'uint16');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_V420_10bpp.yuv'), 'w' );
        fwrite(fileID, lenslet_yuv420_img{3}', 'uint16');
        fclose(fileID);
    else
        lenslet_yuv420_img = downsample(lenslet_yuv_img);
        % RGB Actual writing
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_RGB444_8bpp.rgb'), 'w' );
        fwrite(fileID, permute(lenslet_rgb_img, [2 1 3]), 'uint8');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_R444_8bpp.rgb'), 'w' );
        fwrite(fileID, lenslet_rgb_img(:, :, 1)', 'uint8');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_G444_8bpp.rgb'), 'w' );
        fwrite(fileID, lenslet_rgb_img(:, :, 2)', 'uint8');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_B444_8bpp.rgb'), 'w' );
        fwrite(fileID, lenslet_rgb_img(:, :, 3)', 'uint8');
        fclose(fileID);
        % YUV Actual writing
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_YUV444_8bpp.yuv'), 'w' );
        fwrite(fileID, permute(lenslet_yuv_img, [2 1 3]), 'uint8');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_Y444_8bpp.yuv'), 'w' );
        fwrite(fileID, lenslet_yuv_img(:, :, 1)', 'uint8');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_U444_8bpp.yuv'), 'w' );
        fwrite(fileID, lenslet_yuv_img(:, :, 2)', 'uint8');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_V444_8bpp.yuv'), 'w' );
        fwrite(fileID, lenslet_yuv_img(:, :, 3)', 'uint8');
        fclose(fileID);
        % YUV Actual writing
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_YUV420_8bpp.yuv'), 'w' );
        fwrite(fileID, lenslet_yuv420_img{1}', 'uint8');
        fwrite(fileID, lenslet_yuv420_img{2}', 'uint8');
        fwrite(fileID, lenslet_yuv420_img{3}', 'uint8');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_Y420_8bpp.yuv'), 'w' );
        fwrite(fileID, lenslet_yuv420_img{1}', 'uint8');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_U420_8bpp.yuv'), 'w' );
        fwrite(fileID, lenslet_yuv420_img{2}', 'uint8');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_MI_viola/', name, '_V420_8bpp.yuv'), 'w' );
        fwrite(fileID, lenslet_yuv420_img{3}', 'uint8');
        fclose(fileID);
    end
    ...
    if use_10bpp == 1
        % RGB Actual writing
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_RGB444_10bpp.rgb'), 'w' );
        fwrite(fileID, permute(views_rgb_img, [2 1 3 4]), 'uint16');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_R444_10bpp.rgb'), 'w' );
        fwrite(fileID, permute(squeeze(views_rgb_img(:, :, 1, :)), [2 1 3]), 'uint16');
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_G444_10bpp.rgb'), 'w' );
        fwrite(fileID, permute(squeeze(views_rgb_img(:, :, 2, :)), [2 1 3]), 'uint16');
        fclose(fileID); 
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_B444_10bpp.rgb'), 'w' );
        fwrite(fileID, permute(squeeze(views_rgb_img(:, :, 3, :)), [2 1 3]), 'uint16');
        fclose(fileID);
        % YUV Actual writing
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_YUV444_10bpp.yuv'), 'w' );
        fwrite(fileID, permute(views_yuv_img, [2 1 3 4]), 'uint16');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_Y444_10bpp.yuv'), 'w' );
        fwrite(fileID, permute(squeeze(views_yuv_img(:, :, 1, :)), [2 1 3]), 'uint16');
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_U444_10bpp.yuv'), 'w' );
        fwrite(fileID, permute(squeeze(views_yuv_img(:, :, 2, :)), [2 1 3]), 'uint16');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_V444_10bpp.yuv'), 'w' );
        fwrite(fileID, permute(squeeze(views_yuv_img(:, :, 3, :)), [2 1 3]), 'uint16');
        fclose(fileID);
        % YUV Actual writing
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_YUV420_10bpp.yuv'), 'w' );
        ...
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_Y420_10bpp.yuv'), 'w' );
        for v = 1:num_MIs*num_MIs
            views_yuv420_img = downsample10(views_yuv_img(:,:,:,v));
            fwrite(fileID, views_yuv420_img{1}', 'uint16');
        end
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_U420_10bpp.yuv'), 'w' );
        for v = 1:num_MIs*num_MIs
            views_yuv420_img = downsample10(views_yuv_img(:,:,:,v));
            fwrite(fileID, views_yuv420_img{2}', 'uint16');
        end
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_V420_10bpp.yuv'), 'w' );
        for v = 1:num_MIs*num_MIs
            views_yuv420_img = downsample10(views_yuv_img(:,:,:,v));
            fwrite(fileID, views_yuv420_img{3}', 'uint16');
        end
        ...
        % RGB Actual writing
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_RGB444_8bpp.rgb'), 'w' );
        fwrite(fileID, permute(views_rgb_img, [2 1 3 4]), 'uint8');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_R444_8bpp.rgb'), 'w' );
        fwrite(fileID, permute(squeeze(views_rgb_img(:, :, 1, :)), [2 1 3]), 'uint8');
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_G444_8bpp.rgb'), 'w' );
        fwrite(fileID, permute(squeeze(views_rgb_img(:, :, 2, :)), [2 1 3]), 'uint8');
        fclose(fileID); 
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_B444_8bpp.rgb'), 'w' );
        fwrite(fileID, permute(squeeze(views_rgb_img(:, :, 3, :)), [2 1 3]), 'uint8');
        fclose(fileID);
        % YUV Actual writing
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_YUV444_8bpp.yuv'), 'w' );
        fwrite(fileID, permute(views_yuv_img, [2 1 3 4]), 'uint8');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_Y444_8bpp.yuv'), 'w' );
        fwrite(fileID, permute(squeeze(views_yuv_img(:, :, 1, :)), [2 1 3]), 'uint8');
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_U444_8bpp.yuv'), 'w' );
        fwrite(fileID, permute(squeeze(views_yuv_img(:, :, 2, :)), [2 1 3]), 'uint8');
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_V444_8bpp.yuv'), 'w' );
        fwrite(fileID, permute(squeeze(views_yuv_img(:, :, 3, :)), [2 1 3]), 'uint8');
        fclose(fileID);
        % YUV Actual writing
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_YUV420_8bpp.yuv'), 'w' );
        for v = 1:num_MIs*num_MIs
        ...
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_Y420_8bpp.yuv'), 'w' );
        for v = 1:num_MIs*num_MIs
            views_yuv420_img = downsample(views_yuv_img(:,:,:,v));
            fwrite(fileID, views_yuv420_img{1}', 'uint8');
        end
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_U420_8bpp.yuv'), 'w' );
        for v = 1:num_MIs*num_MIs
            views_yuv420_img = downsample(views_yuv_img(:,:,:,v));
            fwrite(fileID, views_yuv420_img{2}', 'uint8');
        end
        fclose(fileID);
        fileID = fopen( strcat(path, '4DLF_PVS_viola/', name, '_V420_8bpp.yuv'), 'w' );
        for v = 1:num_MIs*num_MIs
            views_yuv420_img = downsample(views_yuv_img(:,:,:,v));
            fwrite(fileID, views_yuv420_img{3}', 'uint8');
        end
